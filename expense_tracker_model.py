...
num_months = int(input("Enter the number of months you have data for: "))
user_data = []
...
user_df['Month'] = range(1, num_months + 1)
...
print("Predicted expenses for the next 6 months:", future_expenses)